...
public class Main {
    public static void main(String[] args) {
        // Usuário 1
        Usuario usuario1 = new UsuarioProxy("Fulano",
                "12345678901",
                "fulano@example.com",
                "Rua A, 123",
                TipoAcesso.AVALIACAO);
        ...
        // Usuário 2
        Usuario usuario2 = new UsuarioProxy("Ciclano",
                "1234554321",
                "ciclano@example.com",
                "Rua B, 123",
                TipoAcesso.LOGADO);
        ...
        // Usuário 3
        Usuario usuario3 = new UsuarioProxy("Deltrano",
                "987456321",
                "deltrano@example.com",
                "Rua C, 123",
                TipoAcesso.COMPRA);
