...
#### Caminho - Avaliações de um Produto
...
#### Caminho - Visualização de Avaliações de um Produto
...
Figura 4. Diagrama de Atividades: Visualização de Avaliação, versão 1. (Fonte: elaborado por Davi Lima e Nicolas Souza, 2023)
</center>
...
[1] Conteúdo acerca dos diagramas de atividade: <https://www.uml-diagrams.org/activity-diagrams.html>(Acesso 10 de
Maio de 2023) <br/>
[2] Material da aula (slides sobre modelagem dinâmica) <br/>
[3] Conteúdo IBM - Diagrama de atividades: <https://www.ibm.com/docs/pt-br/rational-soft-arch/9.7.0?topic=diagrams-activity> <br/>
[4] LucidChart: <https://www.lucidchart.com/pages/> <br/>
[5] Diagrama Causa-Efeito: [Link]()
[6] RichPicture
...
| `1.1`  | 11/05/2023 | Início da Introdução, inclusão da Metodologia e início da seção Elaboração do Diagrama | Nicolas Souza | Davi Matias|
|`1.2`| 13/05/2023 | Adição do diagrama de visualização de avaliações, inclusão da conclusão| Davi Matias ||
