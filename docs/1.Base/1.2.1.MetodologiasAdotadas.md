...
| `1.3`  | 24/04/2023 | Revisão do artefato e correção de imagens                  | Josué Teixeira            | Lucas Gabriel        |
| `1.4`  | 24/04/2023 | Adição de incrementos na seção de metodologias utilizadas. | Nicolas                   | Lucas Gabriel        |
| `1.5`  | 24/04/2023 | Adição das especificações do bot da daily.                 | Guilherme Vilela          | Lucas Gabriel        |
