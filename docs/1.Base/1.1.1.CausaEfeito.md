...
grupo de trabalho, a saber, Josué, [Lucas Felipe](https://github.com/lucasfs1007) e Nicolas. Inicialmente, cada membro
...
|--------|------------|------------------------------------------------------------------|------------------------------------------------|------------------------------------------------|
| `1.0`  | 15/04/2023 | Criação do documento com introdução.                             | [Nicolas](https://github.com/nszchagas)        | [Lucas Felipe](https://github.com/lucasfs1007) |
| `1.1`  | 17/04/2023 | Revisão da introdução e elaboração da metodologia.               | [Lucas Felipe](https://github.com/lucasfs1007) | [Josué](https://github.com/zjosuez)            |
...
| `1.3`  | 21/04/2023 | Finalização da metodologia.                                      | [Nicolas](https://github.com/nszchagas)        |                                                |